...
# ---------------------------------------------------------------------
#SBATCH --job-name=kinGEMs_fluxomics
#SBATCH --account=def-mahadeva
#SBATCH --cpus-per-task=8
#SBATCH --time=0-10:00:00
#SBATCH --mem=64G
#SBATCH --output=logs/pipeline_fluxomics_%j.out
#SBATCH --error=logs/pipeline_fluxomics_%j.err
...
CONFIG_FILE=${1:-configs/fluxomics_iML1515_GEM.json}
