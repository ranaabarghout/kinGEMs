...
#SBATCH --job-name=iECS88_1305
#SBATCH --output=logs/BiGG_models/iECS88_1305_%j.out
#SBATCH --error=logs/BiGG_models/iECS88_1305_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECS88_1305"
echo "Config: configs/BiGG_models/iECS88_1305.json"
CONFIG="configs/BiGG_models/iECS88_1305.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECS88_1305.json --force
EXIT_CODE=$?
