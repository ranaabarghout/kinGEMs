...
#SBATCH --job-name=iZ_1308
#SBATCH --output=logs/BiGG_models/iZ_1308_%j.out
#SBATCH --error=logs/BiGG_models/iZ_1308_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iZ_1308"
echo "Config: configs/BiGG_models/iZ_1308.json"
CONFIG="configs/BiGG_models/iZ_1308.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iZ_1308.json --force
EXIT_CODE=$?
