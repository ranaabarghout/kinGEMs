...
#SBATCH --job-name=iAM_Pv461
#SBATCH --output=logs/BiGG_models/iAM_Pv461_%j.out
#SBATCH --error=logs/BiGG_models/iAM_Pv461_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iAM_Pv461"
echo "Config: configs/BiGG_models/iAM_Pv461.json"
CONFIG="configs/BiGG_models/iAM_Pv461.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iAM_Pv461.json --force
EXIT_CODE=$?
