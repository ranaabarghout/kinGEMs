...
#SBATCH --job-name=iNRG857_1313
#SBATCH --output=logs/BiGG_models/iNRG857_1313_%j.out
#SBATCH --error=logs/BiGG_models/iNRG857_1313_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iNRG857_1313"
echo "Config: configs/BiGG_models/iNRG857_1313.json"
CONFIG="configs/BiGG_models/iNRG857_1313.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iNRG857_1313.json --force
EXIT_CODE=$?
