...
#SBATCH --job-name=iSynCJ816
#SBATCH --output=logs/BiGG_models/iSynCJ816_%j.out
#SBATCH --error=logs/BiGG_models/iSynCJ816_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iSynCJ816"
echo "Config: configs/BiGG_models/iSynCJ816.json"
CONFIG="configs/BiGG_models/iSynCJ816.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iSynCJ816.json --force
EXIT_CODE=$?
