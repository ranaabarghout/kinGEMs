...
#SBATCH --job-name=iEC55989_1330
#SBATCH --output=logs/BiGG_models/iEC55989_1330_%j.out
#SBATCH --error=logs/BiGG_models/iEC55989_1330_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iEC55989_1330"
echo "Config: configs/BiGG_models/iEC55989_1330.json"
CONFIG="configs/BiGG_models/iEC55989_1330.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iEC55989_1330.json --force
EXIT_CODE=$?
