...
#SBATCH --job-name=iSF_1195
#SBATCH --output=logs/BiGG_models/iSF_1195_%j.out
#SBATCH --error=logs/BiGG_models/iSF_1195_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iSF_1195"
echo "Config: configs/BiGG_models/iSF_1195.json"
CONFIG="configs/BiGG_models/iSF_1195.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iSF_1195.json --force
EXIT_CODE=$?
