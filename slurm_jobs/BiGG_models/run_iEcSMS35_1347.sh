...
#SBATCH --job-name=iEcSMS35_1347
#SBATCH --output=logs/BiGG_models/iEcSMS35_1347_%j.out
#SBATCH --error=logs/BiGG_models/iEcSMS35_1347_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iEcSMS35_1347"
echo "Config: configs/BiGG_models/iEcSMS35_1347.json"
CONFIG="configs/BiGG_models/iEcSMS35_1347.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iEcSMS35_1347.json --force
EXIT_CODE=$?
