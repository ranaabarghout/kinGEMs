...
#SBATCH --output=logs/BiGG_models/iAF692_%j.out
#SBATCH --error=logs/BiGG_models/iAF692_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iAF692"
echo "Config: configs/BiGG_models/iAF692.json"
CONFIG="configs/BiGG_models/iAF692.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iAF692.json --force
EXIT_CODE=$?
