...
#SBATCH --job-name=iCHOv1_DG44
#SBATCH --output=logs/BiGG_models/iCHOv1_DG44_%j.out
#SBATCH --error=logs/BiGG_models/iCHOv1_DG44_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iCHOv1_DG44"
echo "Config: configs/BiGG_models/iCHOv1_DG44.json"
CONFIG="configs/BiGG_models/iCHOv1_DG44.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iCHOv1_DG44.json --force
EXIT_CODE=$?
