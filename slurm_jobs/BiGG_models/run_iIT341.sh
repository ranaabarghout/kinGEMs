...
#SBATCH --job-name=iIT341
#SBATCH --output=logs/BiGG_models/iIT341_%j.out
#SBATCH --error=logs/BiGG_models/iIT341_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iIT341"
echo "Config: configs/BiGG_models/iIT341.json"
CONFIG="configs/BiGG_models/iIT341.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iIT341.json --force
EXIT_CODE=$?
