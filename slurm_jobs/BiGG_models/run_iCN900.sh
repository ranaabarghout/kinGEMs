...
#SBATCH --job-name=iCN900
#SBATCH --output=logs/BiGG_models/iCN900_%j.out
#SBATCH --error=logs/BiGG_models/iCN900_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iCN900"
echo "Config: configs/BiGG_models/iCN900.json"
CONFIG="configs/BiGG_models/iCN900.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iCN900.json --force
EXIT_CODE=$?
