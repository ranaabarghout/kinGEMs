...
#SBATCH --job-name=iE2348C_1286
#SBATCH --output=logs/BiGG_models/iE2348C_1286_%j.out
#SBATCH --error=logs/BiGG_models/iE2348C_1286_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iE2348C_1286"
echo "Config: configs/BiGG_models/iE2348C_1286.json"
CONFIG="configs/BiGG_models/iE2348C_1286.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iE2348C_1286.json --force
EXIT_CODE=$?
