...
#SBATCH --job-name=iEK1008
#SBATCH --output=logs/BiGG_models/iEK1008_%j.out
#SBATCH --error=logs/BiGG_models/iEK1008_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iEK1008"
echo "Config: configs/BiGG_models/iEK1008.json"
CONFIG="configs/BiGG_models/iEK1008.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iEK1008.json --force
EXIT_CODE=$?
