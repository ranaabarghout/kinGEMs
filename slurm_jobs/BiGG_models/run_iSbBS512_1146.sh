...
#SBATCH --job-name=iSbBS512_1146
#SBATCH --output=logs/BiGG_models/iSbBS512_1146_%j.out
#SBATCH --error=logs/BiGG_models/iSbBS512_1146_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iSbBS512_1146"
echo "Config: configs/BiGG_models/iSbBS512_1146.json"
CONFIG="configs/BiGG_models/iSbBS512_1146.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iSbBS512_1146.json --force
EXIT_CODE=$?
