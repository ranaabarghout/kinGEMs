...
#SBATCH --job-name=iJN746
#SBATCH --output=logs/BiGG_models/iJN746_%j.out
#SBATCH --error=logs/BiGG_models/iJN746_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iJN746"
echo "Config: configs/BiGG_models/iJN746.json"
CONFIG="configs/BiGG_models/iJN746.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iJN746.json --force
EXIT_CODE=$?
