...
#SBATCH --job-name=iYS1720
#SBATCH --output=logs/BiGG_models/iYS1720_%j.out
#SBATCH --error=logs/BiGG_models/iYS1720_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iYS1720"
echo "Config: configs/BiGG_models/iYS1720.json"
CONFIG="configs/BiGG_models/iYS1720.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iYS1720.json --force
EXIT_CODE=$?
