...
#SBATCH --job-name=iEC1349_Crooks
#SBATCH --output=logs/BiGG_models/iEC1349_Crooks_%j.out
#SBATCH --error=logs/BiGG_models/iEC1349_Crooks_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iEC1349_Crooks"
echo "Config: configs/BiGG_models/iEC1349_Crooks.json"
CONFIG="configs/BiGG_models/iEC1349_Crooks.json"
