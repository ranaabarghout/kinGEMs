...
#SBATCH --job-name=iPC815
#SBATCH --output=logs/BiGG_models/iPC815_%j.out
#SBATCH --error=logs/BiGG_models/iPC815_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iPC815"
echo "Config: configs/BiGG_models/iPC815.json"
CONFIG="configs/BiGG_models/iPC815.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iPC815.json --force
EXIT_CODE=$?
