...
#SBATCH --job-name=iJB785
#SBATCH --output=logs/BiGG_models/iJB785_%j.out
#SBATCH --error=logs/BiGG_models/iJB785_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iJB785"
echo "Config: configs/BiGG_models/iJB785.json"
CONFIG="configs/BiGG_models/iJB785.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iJB785.json --force
EXIT_CODE=$?
