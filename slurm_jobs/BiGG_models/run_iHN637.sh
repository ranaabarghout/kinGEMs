...
#SBATCH --job-name=iHN637
#SBATCH --output=logs/BiGG_models/iHN637_%j.out
#SBATCH --error=logs/BiGG_models/iHN637_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iHN637"
echo "Config: configs/BiGG_models/iHN637.json"
CONFIG="configs/BiGG_models/iHN637.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iHN637.json --force
EXIT_CODE=$?
