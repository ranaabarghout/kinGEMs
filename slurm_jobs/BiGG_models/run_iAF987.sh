...
#SBATCH --job-name=iAF987
#SBATCH --output=logs/BiGG_models/iAF987_%j.out
#SBATCH --error=logs/BiGG_models/iAF987_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iAF987"
echo "Config: configs/BiGG_models/iAF987.json"
CONFIG="configs/BiGG_models/iAF987.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iAF987.json --force
EXIT_CODE=$?
