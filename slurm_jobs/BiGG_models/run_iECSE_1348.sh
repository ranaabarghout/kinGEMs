...
#SBATCH --job-name=iECSE_1348
#SBATCH --output=logs/BiGG_models/iECSE_1348_%j.out
#SBATCH --error=logs/BiGG_models/iECSE_1348_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECSE_1348"
echo "Config: configs/BiGG_models/iECSE_1348.json"
CONFIG="configs/BiGG_models/iECSE_1348.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECSE_1348.json --force
EXIT_CODE=$?
