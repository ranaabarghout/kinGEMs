...
#SBATCH --job-name=iML1515
#SBATCH --output=logs/BiGG_models/iML1515_%j.out
#SBATCH --error=logs/BiGG_models/iML1515_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iML1515"
echo "Config: configs/BiGG_models/iML1515.json"
CONFIG="configs/BiGG_models/iML1515.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iML1515.json --force
EXIT_CODE=$?
