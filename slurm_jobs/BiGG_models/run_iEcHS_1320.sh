...
#SBATCH --job-name=iEcHS_1320
#SBATCH --output=logs/BiGG_models/iEcHS_1320_%j.out
#SBATCH --error=logs/BiGG_models/iEcHS_1320_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iEcHS_1320"
echo "Config: configs/BiGG_models/iEcHS_1320.json"
CONFIG="configs/BiGG_models/iEcHS_1320.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iEcHS_1320.json --force
EXIT_CODE=$?
