...
#SBATCH --job-name=iS_1188
#SBATCH --output=logs/BiGG_models/iS_1188_%j.out
#SBATCH --error=logs/BiGG_models/iS_1188_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iS_1188"
echo "Config: configs/BiGG_models/iS_1188.json"
CONFIG="configs/BiGG_models/iS_1188.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iS_1188.json --force
EXIT_CODE=$?
