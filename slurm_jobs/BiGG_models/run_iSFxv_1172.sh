...
#SBATCH --job-name=iSFxv_1172
#SBATCH --output=logs/BiGG_models/iSFxv_1172_%j.out
#SBATCH --error=logs/BiGG_models/iSFxv_1172_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iSFxv_1172"
echo "Config: configs/BiGG_models/iSFxv_1172.json"
CONFIG="configs/BiGG_models/iSFxv_1172.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iSFxv_1172.json --force
EXIT_CODE=$?
