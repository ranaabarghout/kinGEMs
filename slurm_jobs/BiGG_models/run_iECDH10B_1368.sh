...
#SBATCH --job-name=iECDH10B_1368
#SBATCH --output=logs/BiGG_models/iECDH10B_1368_%j.out
#SBATCH --error=logs/BiGG_models/iECDH10B_1368_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECDH10B_1368"
echo "Config: configs/BiGG_models/iECDH10B_1368.json"
CONFIG="configs/BiGG_models/iECDH10B_1368.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECDH10B_1368.json --force
EXIT_CODE=$?
