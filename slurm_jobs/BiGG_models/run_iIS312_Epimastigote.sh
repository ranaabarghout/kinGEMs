...
#SBATCH --job-name=iIS312_Epimastigote
#SBATCH --output=logs/BiGG_models/iIS312_Epimastigote_%j.out
#SBATCH --error=logs/BiGG_models/iIS312_Epimastigote_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iIS312_Epimastigote"
echo "Config: configs/BiGG_models/iIS312_Epimastigote.json"
CONFIG="configs/BiGG_models/iIS312_Epimastigote.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iIS312_Epimastigote.json --force
EXIT_CODE=$?
