...
#SBATCH --job-name=iAPECO1_1312
#SBATCH --output=logs/BiGG_models/iAPECO1_1312_%j.out
#SBATCH --error=logs/BiGG_models/iAPECO1_1312_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iAPECO1_1312"
echo "Config: configs/BiGG_models/iAPECO1_1312.json"
CONFIG="configs/BiGG_models/iAPECO1_1312.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iAPECO1_1312.json --force
EXIT_CODE=$?
