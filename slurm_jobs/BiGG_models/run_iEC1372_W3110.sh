...
#SBATCH --job-name=iEC1372_W3110
#SBATCH --output=logs/BiGG_models/iEC1372_W3110_%j.out
#SBATCH --error=logs/BiGG_models/iEC1372_W3110_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iEC1372_W3110"
echo "Config: configs/BiGG_models/iEC1372_W3110.json"
CONFIG="configs/BiGG_models/iEC1372_W3110.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iEC1372_W3110.json --force
EXIT_CODE=$?
