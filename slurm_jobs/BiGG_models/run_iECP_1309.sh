...
#SBATCH --job-name=iECP_1309
#SBATCH --output=logs/BiGG_models/iECP_1309_%j.out
#SBATCH --error=logs/BiGG_models/iECP_1309_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECP_1309"
echo "Config: configs/BiGG_models/iECP_1309.json"
CONFIG="configs/BiGG_models/iECP_1309.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECP_1309.json --force
EXIT_CODE=$?
