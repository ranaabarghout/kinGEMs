...
#SBATCH --job-name=iYL1228
#SBATCH --output=logs/BiGG_models/iYL1228_%j.out
#SBATCH --error=logs/BiGG_models/iYL1228_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iYL1228"
echo "Config: configs/BiGG_models/iYL1228.json"
CONFIG="configs/BiGG_models/iYL1228.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iYL1228.json --force
EXIT_CODE=$?
