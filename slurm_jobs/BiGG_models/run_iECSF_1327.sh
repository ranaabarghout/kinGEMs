...
#SBATCH --job-name=iECSF_1327
#SBATCH --output=logs/BiGG_models/iECSF_1327_%j.out
#SBATCH --error=logs/BiGG_models/iECSF_1327_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECSF_1327"
echo "Config: configs/BiGG_models/iECSF_1327.json"
CONFIG="configs/BiGG_models/iECSF_1327.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECSF_1327.json --force
EXIT_CODE=$?
