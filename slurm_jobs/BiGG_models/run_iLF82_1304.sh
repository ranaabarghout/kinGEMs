...
#SBATCH --job-name=iLF82_1304
#SBATCH --output=logs/BiGG_models/iLF82_1304_%j.out
#SBATCH --error=logs/BiGG_models/iLF82_1304_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iLF82_1304"
echo "Config: configs/BiGG_models/iLF82_1304.json"
CONFIG="configs/BiGG_models/iLF82_1304.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iLF82_1304.json --force
EXIT_CODE=$?
