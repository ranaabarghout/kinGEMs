...
#SBATCH --job-name=iY75_1357
#SBATCH --output=logs/BiGG_models/iY75_1357_%j.out
#SBATCH --error=logs/BiGG_models/iY75_1357_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iY75_1357"
echo "Config: configs/BiGG_models/iY75_1357.json"
CONFIG="configs/BiGG_models/iY75_1357.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iY75_1357.json --force
EXIT_CODE=$?
