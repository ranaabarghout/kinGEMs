...
#SBATCH --job-name=iEC1344_C
#SBATCH --output=logs/BiGG_models/iEC1344_C_%j.out
#SBATCH --error=logs/BiGG_models/iEC1344_C_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iEC1344_C"
echo "Config: configs/BiGG_models/iEC1344_C.json"
CONFIG="configs/BiGG_models/iEC1344_C.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iEC1344_C.json --force
EXIT_CODE=$?
