...
#SBATCH --job-name=iAM_Pc455
#SBATCH --output=logs/BiGG_models/iAM_Pc455_%j.out
#SBATCH --error=logs/BiGG_models/iAM_Pc455_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iAM_Pc455"
echo "Config: configs/BiGG_models/iAM_Pc455.json"
CONFIG="configs/BiGG_models/iAM_Pc455.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iAM_Pc455.json --force
EXIT_CODE=$?
