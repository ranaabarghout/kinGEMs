...
#SBATCH --job-name=iSBO_1134
#SBATCH --output=logs/BiGG_models/iSBO_1134_%j.out
#SBATCH --error=logs/BiGG_models/iSBO_1134_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iSBO_1134"
echo "Config: configs/BiGG_models/iSBO_1134.json"
CONFIG="configs/BiGG_models/iSBO_1134.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iSBO_1134.json --force
EXIT_CODE=$?
