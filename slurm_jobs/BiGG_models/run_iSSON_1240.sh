...
#SBATCH --job-name=iSSON_1240
#SBATCH --output=logs/BiGG_models/iSSON_1240_%j.out
#SBATCH --error=logs/BiGG_models/iSSON_1240_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iSSON_1240"
echo "Config: configs/BiGG_models/iSSON_1240.json"
CONFIG="configs/BiGG_models/iSSON_1240.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iSSON_1240.json --force
EXIT_CODE=$?
