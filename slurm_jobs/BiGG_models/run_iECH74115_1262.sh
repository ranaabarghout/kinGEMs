...
#SBATCH --job-name=iECH74115_1262
#SBATCH --output=logs/BiGG_models/iECH74115_1262_%j.out
#SBATCH --error=logs/BiGG_models/iECH74115_1262_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECH74115_1262"
echo "Config: configs/BiGG_models/iECH74115_1262.json"
CONFIG="configs/BiGG_models/iECH74115_1262.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECH74115_1262.json --force
EXIT_CODE=$?
