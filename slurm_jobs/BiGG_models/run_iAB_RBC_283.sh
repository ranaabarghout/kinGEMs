...
#SBATCH --job-name=iAB_RBC_283
#SBATCH --output=logs/BiGG_models/iAB_RBC_283_%j.out
#SBATCH --error=logs/BiGG_models/iAB_RBC_283_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iAB_RBC_283"
echo "Config: configs/BiGG_models/iAB_RBC_283.json"
CONFIG="configs/BiGG_models/iAB_RBC_283.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iAB_RBC_283.json --force
EXIT_CODE=$?
