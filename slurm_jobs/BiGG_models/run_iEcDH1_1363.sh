...
#SBATCH --job-name=iEcDH1_1363
#SBATCH --output=logs/BiGG_models/iEcDH1_1363_%j.out
#SBATCH --error=logs/BiGG_models/iEcDH1_1363_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iEcDH1_1363"
echo "Config: configs/BiGG_models/iEcDH1_1363.json"
CONFIG="configs/BiGG_models/iEcDH1_1363.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iEcDH1_1363.json --force
EXIT_CODE=$?
