...
#SBATCH --job-name=iUMN146_1321
#SBATCH --output=logs/BiGG_models/iUMN146_1321_%j.out
#SBATCH --error=logs/BiGG_models/iUMN146_1321_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iUMN146_1321"
echo "Config: configs/BiGG_models/iUMN146_1321.json"
CONFIG="configs/BiGG_models/iUMN146_1321.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iUMN146_1321.json --force
EXIT_CODE=$?
