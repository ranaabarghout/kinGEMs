...
#SBATCH --job-name=iSFV_1184
#SBATCH --output=logs/BiGG_models/iSFV_1184_%j.out
#SBATCH --error=logs/BiGG_models/iSFV_1184_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iSFV_1184"
echo "Config: configs/BiGG_models/iSFV_1184.json"
CONFIG="configs/BiGG_models/iSFV_1184.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iSFV_1184.json --force
EXIT_CODE=$?
