...
#SBATCH --job-name=Recon3D
#SBATCH --output=logs/BiGG_models/Recon3D_%j.out
#SBATCH --error=logs/BiGG_models/Recon3D_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for Recon3D"
echo "Config: configs/BiGG_models/Recon3D.json"
CONFIG="configs/BiGG_models/Recon3D.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/Recon3D.json --force
EXIT_CODE=$?
