...
#SBATCH --job-name=iNF517
#SBATCH --output=logs/BiGG_models/iNF517_%j.out
#SBATCH --error=logs/BiGG_models/iNF517_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iNF517"
echo "Config: configs/BiGG_models/iNF517.json"
CONFIG="configs/BiGG_models/iNF517.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iNF517.json --force
EXIT_CODE=$?
