...
#SBATCH --job-name=iSB619
#SBATCH --output=logs/BiGG_models/iSB619_%j.out
#SBATCH --error=logs/BiGG_models/iSB619_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iSB619"
echo "Config: configs/BiGG_models/iSB619.json"
CONFIG="configs/BiGG_models/iSB619.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iSB619.json --force
EXIT_CODE=$?
