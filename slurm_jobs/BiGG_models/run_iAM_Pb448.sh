...
#SBATCH --job-name=iAM_Pb448
#SBATCH --output=logs/BiGG_models/iAM_Pb448_%j.out
#SBATCH --error=logs/BiGG_models/iAM_Pb448_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iAM_Pb448"
echo "Config: configs/BiGG_models/iAM_Pb448.json"
CONFIG="configs/BiGG_models/iAM_Pb448.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iAM_Pb448.json --force
EXIT_CODE=$?
