...
#SBATCH --job-name=ic_1306
#SBATCH --output=logs/BiGG_models/ic_1306_%j.out
#SBATCH --error=logs/BiGG_models/ic_1306_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for ic_1306"
echo "Config: configs/BiGG_models/ic_1306.json"
CONFIG="configs/BiGG_models/ic_1306.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/ic_1306.json --force
EXIT_CODE=$?
