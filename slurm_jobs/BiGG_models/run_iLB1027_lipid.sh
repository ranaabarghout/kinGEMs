...
#SBATCH --job-name=iLB1027_lipid
#SBATCH --output=logs/BiGG_models/iLB1027_lipid_%j.out
#SBATCH --error=logs/BiGG_models/iLB1027_lipid_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iLB1027_lipid"
echo "Config: configs/BiGG_models/iLB1027_lipid.json"
CONFIG="configs/BiGG_models/iLB1027_lipid.json"
