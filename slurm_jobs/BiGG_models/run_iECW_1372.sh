...
#SBATCH --job-name=iECW_1372
#SBATCH --output=logs/BiGG_models/iECW_1372_%j.out
#SBATCH --error=logs/BiGG_models/iECW_1372_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECW_1372"
echo "Config: configs/BiGG_models/iECW_1372.json"
CONFIG="configs/BiGG_models/iECW_1372.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECW_1372.json --force
EXIT_CODE=$?
