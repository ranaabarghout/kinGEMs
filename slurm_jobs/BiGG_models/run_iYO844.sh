...
#SBATCH --job-name=iYO844
#SBATCH --output=logs/BiGG_models/iYO844_%j.out
#SBATCH --error=logs/BiGG_models/iYO844_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iYO844"
echo "Config: configs/BiGG_models/iYO844.json"
CONFIG="configs/BiGG_models/iYO844.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iYO844.json --force
EXIT_CODE=$?
