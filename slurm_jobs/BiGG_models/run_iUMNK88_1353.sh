...
#SBATCH --job-name=iUMNK88_1353
#SBATCH --output=logs/BiGG_models/iUMNK88_1353_%j.out
#SBATCH --error=logs/BiGG_models/iUMNK88_1353_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iUMNK88_1353"
echo "Config: configs/BiGG_models/iUMNK88_1353.json"
CONFIG="configs/BiGG_models/iUMNK88_1353.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iUMNK88_1353.json --force
EXIT_CODE=$?
