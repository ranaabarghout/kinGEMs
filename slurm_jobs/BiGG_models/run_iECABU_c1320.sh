...
#SBATCH --job-name=iECABU_c1320
#SBATCH --output=logs/BiGG_models/iECABU_c1320_%j.out
#SBATCH --error=logs/BiGG_models/iECABU_c1320_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECABU_c1320"
echo "Config: configs/BiGG_models/iECABU_c1320.json"
CONFIG="configs/BiGG_models/iECABU_c1320.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECABU_c1320.json --force
EXIT_CODE=$?
