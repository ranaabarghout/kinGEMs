...
#SBATCH --job-name=iYS854
#SBATCH --output=logs/BiGG_models/iYS854_%j.out
#SBATCH --error=logs/BiGG_models/iYS854_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iYS854"
echo "Config: configs/BiGG_models/iYS854.json"
CONFIG="configs/BiGG_models/iYS854.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iYS854.json --force
EXIT_CODE=$?
