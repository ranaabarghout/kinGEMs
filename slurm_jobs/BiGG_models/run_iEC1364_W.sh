...
#SBATCH --job-name=iEC1364_W
#SBATCH --output=logs/BiGG_models/iEC1364_W_%j.out
#SBATCH --error=logs/BiGG_models/iEC1364_W_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iEC1364_W"
echo "Config: configs/BiGG_models/iEC1364_W.json"
CONFIG="configs/BiGG_models/iEC1364_W.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iEC1364_W.json --force
EXIT_CODE=$?
