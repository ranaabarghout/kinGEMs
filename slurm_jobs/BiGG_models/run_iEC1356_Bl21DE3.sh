...
#SBATCH --job-name=iEC1356_Bl21DE3
#SBATCH --output=logs/BiGG_models/iEC1356_Bl21DE3_%j.out
#SBATCH --error=logs/BiGG_models/iEC1356_Bl21DE3_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iEC1356_Bl21DE3"
echo "Config: configs/BiGG_models/iEC1356_Bl21DE3.json"
CONFIG="configs/BiGG_models/iEC1356_Bl21DE3.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iEC1356_Bl21DE3.json --force
EXIT_CODE=$?
