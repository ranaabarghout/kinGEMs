...
#SBATCH --job-name=iECIAI1_1343
#SBATCH --output=logs/BiGG_models/iECIAI1_1343_%j.out
#SBATCH --error=logs/BiGG_models/iECIAI1_1343_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECIAI1_1343"
echo "Config: configs/BiGG_models/iECIAI1_1343.json"
CONFIG="configs/BiGG_models/iECIAI1_1343.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECIAI1_1343.json --force
EXIT_CODE=$?
