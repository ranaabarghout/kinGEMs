...
#SBATCH --job-name=iEC042_1314
#SBATCH --output=logs/BiGG_models/iEC042_1314_%j.out
#SBATCH --error=logs/BiGG_models/iEC042_1314_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iEC042_1314"
echo "Config: configs/BiGG_models/iEC042_1314.json"
CONFIG="configs/BiGG_models/iEC042_1314.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iEC042_1314.json --force
EXIT_CODE=$?
