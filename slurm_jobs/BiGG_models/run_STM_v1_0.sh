...
#SBATCH --job-name=STM_v1_0
#SBATCH --output=logs/BiGG_models/STM_v1_0_%j.out
#SBATCH --error=logs/BiGG_models/STM_v1_0_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for STM_v1_0"
echo "Config: configs/BiGG_models/STM_v1_0.json"
CONFIG="configs/BiGG_models/STM_v1_0.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/STM_v1_0.json --force
EXIT_CODE=$?
