...
#SBATCH --job-name=iECD_1391
#SBATCH --output=logs/BiGG_models/iECD_1391_%j.out
#SBATCH --error=logs/BiGG_models/iECD_1391_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECD_1391"
echo "Config: configs/BiGG_models/iECD_1391.json"
CONFIG="configs/BiGG_models/iECD_1391.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECD_1391.json --force
EXIT_CODE=$?
