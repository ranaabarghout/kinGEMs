...
#SBATCH --job-name=iSDY_1059
#SBATCH --output=logs/BiGG_models/iSDY_1059_%j.out
#SBATCH --error=logs/BiGG_models/iSDY_1059_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iSDY_1059"
echo "Config: configs/BiGG_models/iSDY_1059.json"
CONFIG="configs/BiGG_models/iSDY_1059.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iSDY_1059.json --force
EXIT_CODE=$?
