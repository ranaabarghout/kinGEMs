...
#SBATCH --job-name=iEKO11_1354
#SBATCH --output=logs/BiGG_models/iEKO11_1354_%j.out
#SBATCH --error=logs/BiGG_models/iEKO11_1354_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iEKO11_1354"
echo "Config: configs/BiGG_models/iEKO11_1354.json"
CONFIG="configs/BiGG_models/iEKO11_1354.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iEKO11_1354.json --force
EXIT_CODE=$?
