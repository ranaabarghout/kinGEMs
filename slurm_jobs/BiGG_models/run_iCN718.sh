...
#SBATCH --job-name=iCN718
#SBATCH --output=logs/BiGG_models/iCN718_%j.out
#SBATCH --error=logs/BiGG_models/iCN718_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iCN718"
echo "Config: configs/BiGG_models/iCN718.json"
CONFIG="configs/BiGG_models/iCN718.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iCN718.json --force
EXIT_CODE=$?
