...
#SBATCH --job-name=iAM_Pf480
#SBATCH --output=logs/BiGG_models/iAM_Pf480_%j.out
#SBATCH --error=logs/BiGG_models/iAM_Pf480_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iAM_Pf480"
echo "Config: configs/BiGG_models/iAM_Pf480.json"
CONFIG="configs/BiGG_models/iAM_Pf480.json"
