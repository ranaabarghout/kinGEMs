...
#SBATCH --job-name=iECUMN_1333
#SBATCH --output=logs/BiGG_models/iECUMN_1333_%j.out
#SBATCH --error=logs/BiGG_models/iECUMN_1333_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECUMN_1333"
echo "Config: configs/BiGG_models/iECUMN_1333.json"
CONFIG="configs/BiGG_models/iECUMN_1333.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECUMN_1333.json --force
EXIT_CODE=$?
