...
#SBATCH --job-name=iAF1260
#SBATCH --output=logs/BiGG_models/iAF1260_%j.out
#SBATCH --error=logs/BiGG_models/iAF1260_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iAF1260"
echo "Config: configs/BiGG_models/iAF1260.json"
CONFIG="configs/BiGG_models/iAF1260.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iAF1260.json --force
EXIT_CODE=$?
