...
#SBATCH --job-name=iAM_Pk459
#SBATCH --output=logs/BiGG_models/iAM_Pk459_%j.out
#SBATCH --error=logs/BiGG_models/iAM_Pk459_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iAM_Pk459"
echo "Config: configs/BiGG_models/iAM_Pk459.json"
CONFIG="configs/BiGG_models/iAM_Pk459.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iAM_Pk459.json --force
EXIT_CODE=$?
