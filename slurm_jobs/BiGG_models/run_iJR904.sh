...
#SBATCH --job-name=iJR904
#SBATCH --output=logs/BiGG_models/iJR904_%j.out
#SBATCH --error=logs/BiGG_models/iJR904_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iJR904"
echo "Config: configs/BiGG_models/iJR904.json"
CONFIG="configs/BiGG_models/iJR904.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iJR904.json --force
EXIT_CODE=$?
