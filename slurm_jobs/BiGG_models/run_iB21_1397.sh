...
#SBATCH --job-name=iB21_1397
#SBATCH --output=logs/BiGG_models/iB21_1397_%j.out
#SBATCH --error=logs/BiGG_models/iB21_1397_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iB21_1397"
echo "Config: configs/BiGG_models/iB21_1397.json"
CONFIG="configs/BiGG_models/iB21_1397.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iB21_1397.json --force
EXIT_CODE=$?
