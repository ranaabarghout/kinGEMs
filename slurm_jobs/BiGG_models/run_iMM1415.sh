...
#SBATCH --job-name=iMM1415
#SBATCH --output=logs/BiGG_models/iMM1415_%j.out
#SBATCH --error=logs/BiGG_models/iMM1415_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iMM1415"
echo "Config: configs/BiGG_models/iMM1415.json"
CONFIG="configs/BiGG_models/iMM1415.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iMM1415.json --force
EXIT_CODE=$?
