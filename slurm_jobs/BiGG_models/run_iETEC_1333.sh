...
#SBATCH --job-name=iETEC_1333
#SBATCH --output=logs/BiGG_models/iETEC_1333_%j.out
#SBATCH --error=logs/BiGG_models/iETEC_1333_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iETEC_1333"
echo "Config: configs/BiGG_models/iETEC_1333.json"
CONFIG="configs/BiGG_models/iETEC_1333.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iETEC_1333.json --force
EXIT_CODE=$?
