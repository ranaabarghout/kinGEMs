...
#SBATCH --job-name=iAT_PLT_636
#SBATCH --output=logs/BiGG_models/iAT_PLT_636_%j.out
#SBATCH --error=logs/BiGG_models/iAT_PLT_636_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iAT_PLT_636"
echo "Config: configs/BiGG_models/iAT_PLT_636.json"
CONFIG="configs/BiGG_models/iAT_PLT_636.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iAT_PLT_636.json --force
EXIT_CODE=$?
