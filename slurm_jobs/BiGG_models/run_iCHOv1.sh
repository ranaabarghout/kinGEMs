...
#SBATCH --job-name=iCHOv1
#SBATCH --output=logs/BiGG_models/iCHOv1_%j.out
#SBATCH --error=logs/BiGG_models/iCHOv1_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iCHOv1"
echo "Config: configs/BiGG_models/iCHOv1.json"
CONFIG="configs/BiGG_models/iCHOv1.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iCHOv1.json --force
EXIT_CODE=$?
