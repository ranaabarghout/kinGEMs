...
#SBATCH --job-name=iEcE24377_1341
#SBATCH --output=logs/BiGG_models/iEcE24377_1341_%j.out
#SBATCH --error=logs/BiGG_models/iEcE24377_1341_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iEcE24377_1341"
echo "Config: configs/BiGG_models/iEcE24377_1341.json"
CONFIG="configs/BiGG_models/iEcE24377_1341.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iEcE24377_1341.json --force
EXIT_CODE=$?
