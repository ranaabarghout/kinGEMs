...
#SBATCH --job-name=iRC1080
#SBATCH --output=logs/BiGG_models/iRC1080_%j.out
#SBATCH --error=logs/BiGG_models/iRC1080_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iRC1080"
echo "Config: configs/BiGG_models/iRC1080.json"
CONFIG="configs/BiGG_models/iRC1080.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iRC1080.json --force
EXIT_CODE=$?
