...
#SBATCH --job-name=iECDH1ME8569_1439
#SBATCH --output=logs/BiGG_models/iECDH1ME8569_1439_%j.out
#SBATCH --error=logs/BiGG_models/iECDH1ME8569_1439_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECDH1ME8569_1439"
echo "Config: configs/BiGG_models/iECDH1ME8569_1439.json"
CONFIG="configs/BiGG_models/iECDH1ME8569_1439.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECDH1ME8569_1439.json --force
EXIT_CODE=$?
