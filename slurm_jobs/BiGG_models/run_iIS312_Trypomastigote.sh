...
#SBATCH --job-name=iIS312_Trypomastigote
#SBATCH --output=logs/BiGG_models/iIS312_Trypomastigote_%j.out
#SBATCH --error=logs/BiGG_models/iIS312_Trypomastigote_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iIS312_Trypomastigote"
echo "Config: configs/BiGG_models/iIS312_Trypomastigote.json"
CONFIG="configs/BiGG_models/iIS312_Trypomastigote.json"
