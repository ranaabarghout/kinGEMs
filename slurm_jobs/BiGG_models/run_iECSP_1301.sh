...
#SBATCH --job-name=iECSP_1301
#SBATCH --output=logs/BiGG_models/iECSP_1301_%j.out
#SBATCH --error=logs/BiGG_models/iECSP_1301_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECSP_1301"
echo "Config: configs/BiGG_models/iECSP_1301.json"
CONFIG="configs/BiGG_models/iECSP_1301.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECSP_1301.json --force
EXIT_CODE=$?
