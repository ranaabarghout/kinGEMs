...
#SBATCH --job-name=iJN1463
#SBATCH --output=logs/BiGG_models/iJN1463_%j.out
#SBATCH --error=logs/BiGG_models/iJN1463_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iJN1463"
echo "Config: configs/BiGG_models/iJN1463.json"
CONFIG="configs/BiGG_models/iJN1463.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iJN1463.json --force
EXIT_CODE=$?
