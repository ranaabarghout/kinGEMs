...
#SBATCH --job-name=iBWG_1329
#SBATCH --output=logs/BiGG_models/iBWG_1329_%j.out
#SBATCH --error=logs/BiGG_models/iBWG_1329_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iBWG_1329"
echo "Config: configs/BiGG_models/iBWG_1329.json"
CONFIG="configs/BiGG_models/iBWG_1329.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iBWG_1329.json --force
EXIT_CODE=$?
