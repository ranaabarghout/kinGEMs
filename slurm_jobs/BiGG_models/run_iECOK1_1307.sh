...
#SBATCH --job-name=iECOK1_1307
#SBATCH --output=logs/BiGG_models/iECOK1_1307_%j.out
#SBATCH --error=logs/BiGG_models/iECOK1_1307_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECOK1_1307"
echo "Config: configs/BiGG_models/iECOK1_1307.json"
CONFIG="configs/BiGG_models/iECOK1_1307.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECOK1_1307.json --force
EXIT_CODE=$?
