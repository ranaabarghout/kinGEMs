...
#SBATCH --job-name=iAF1260b
#SBATCH --output=logs/BiGG_models/iAF1260b_%j.out
#SBATCH --error=logs/BiGG_models/iAF1260b_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iAF1260b"
echo "Config: configs/BiGG_models/iAF1260b.json"
CONFIG="configs/BiGG_models/iAF1260b.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iAF1260b.json --force
EXIT_CODE=$?
