...
#SBATCH --job-name=iLJ478
#SBATCH --output=logs/BiGG_models/iLJ478_%j.out
#SBATCH --error=logs/BiGG_models/iLJ478_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iLJ478"
echo "Config: configs/BiGG_models/iLJ478.json"
CONFIG="configs/BiGG_models/iLJ478.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iLJ478.json --force
EXIT_CODE=$?
