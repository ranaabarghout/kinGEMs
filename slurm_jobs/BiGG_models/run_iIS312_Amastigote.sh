...
#SBATCH --job-name=iIS312_Amastigote
#SBATCH --output=logs/BiGG_models/iIS312_Amastigote_%j.out
#SBATCH --error=logs/BiGG_models/iIS312_Amastigote_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iIS312_Amastigote"
echo "Config: configs/BiGG_models/iIS312_Amastigote.json"
CONFIG="configs/BiGG_models/iIS312_Amastigote.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iIS312_Amastigote.json --force
EXIT_CODE=$?
