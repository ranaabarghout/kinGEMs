...
#SBATCH --job-name=iECO26_1355
#SBATCH --output=logs/BiGG_models/iECO26_1355_%j.out
#SBATCH --error=logs/BiGG_models/iECO26_1355_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECO26_1355"
echo "Config: configs/BiGG_models/iECO26_1355.json"
CONFIG="configs/BiGG_models/iECO26_1355.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECO26_1355.json --force
EXIT_CODE=$?
