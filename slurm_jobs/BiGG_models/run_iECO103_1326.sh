...
#SBATCH --job-name=iECO103_1326
#SBATCH --output=logs/BiGG_models/iECO103_1326_%j.out
#SBATCH --error=logs/BiGG_models/iECO103_1326_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECO103_1326"
echo "Config: configs/BiGG_models/iECO103_1326.json"
CONFIG="configs/BiGG_models/iECO103_1326.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECO103_1326.json --force
EXIT_CODE=$?
