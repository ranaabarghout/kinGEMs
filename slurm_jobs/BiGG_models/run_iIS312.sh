...
#SBATCH --job-name=iIS312
#SBATCH --output=logs/BiGG_models/iIS312_%j.out
#SBATCH --error=logs/BiGG_models/iIS312_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iIS312"
echo "Config: configs/BiGG_models/iIS312.json"
CONFIG="configs/BiGG_models/iIS312.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iIS312.json --force
EXIT_CODE=$?
