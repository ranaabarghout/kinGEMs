...
#SBATCH --job-name=iECB_1328
#SBATCH --output=logs/BiGG_models/iECB_1328_%j.out
#SBATCH --error=logs/BiGG_models/iECB_1328_%j.err
...
# Run pipeline
echo "Starting kinGEMs pipeline for iECB_1328"
echo "Config: configs/BiGG_models/iECB_1328.json"
CONFIG="configs/BiGG_models/iECB_1328.json"
echo "Starting run at: $(date)"
echo ""

python scripts/run_pipeline.py configs/BiGG_models/iECB_1328.json --force
EXIT_CODE=$?
