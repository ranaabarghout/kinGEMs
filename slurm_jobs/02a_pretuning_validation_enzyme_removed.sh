#!/bin/bash
# ---------------------------------------------------------------------
# SLURM script for Pre-tuning kinGEMs validation (enzyme constraints REMOVED)
...
# Time: ~3-5 days
# ---------------------------------------------------------------------
#SBATCH --job-name=pretuning_enz_removed
#SBATCH --account=def-mahadeva
#SBATCH --cpus-per-task=8
#SBATCH --time=7-00:00:00
#SBATCH --mem=120G
#SBATCH --output=/project/def-mahadeva/ranaab/kinGEMs_v2/logs/pretuning_removed_%j.out
#SBATCH --error=/project/def-mahadeva/ranaab/kinGEMs_v2/logs/pretuning_removed_%j.err
...
# Run pre-tuning validation with enzyme constraints REMOVED
echo "Running Pre-tuning kinGEMs validation (enzyme removed)..."
